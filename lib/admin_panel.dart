          ...
          ? SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () {
                        addDocument(cName!, subServiceController.text,
...
Future<void> addDocument(String cName, String docName, String docs) async {
  var documents = {'documents': documentController.text};

  FirebaseFirestore.instance.collection(cName).doc(docName).set(docs as Map<String, dynamic>);
}
